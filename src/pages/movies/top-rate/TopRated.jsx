...
const TopRated = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const response = await fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=fbb2ad881df28e33842f45f5313e2b21');
  ...
  <Navbar/>
    <div className="container mx-auto w-[75%]">
      <div className="mt-5 flex gap-3 justify-center">
        <div>
          <h1 className="text-xl ml-4 text-black ">Top Rated TV Shows</h1>
          <FilterPanel />
        </div>
